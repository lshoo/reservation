...
pub trait Rsvp {
    ...
    /// delete reservation
    async fn delete_reservation(&self, id: ReservationId) -> Result<(), ReservationError>;
    /// get reservation by id
    async fn get(&self, id: ReservationId) -> Result<Option<abi::Reservation>, ReservationError>;
    // query reservations
    async fn query(
        &self,
